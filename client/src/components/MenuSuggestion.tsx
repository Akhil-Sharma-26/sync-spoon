...
const MenuSuggestionGenerator: React.FC = () => {
    ...
    const handleGenerateMenu = async (values: any) => {
        setIsLoading1(true);
        try {
            const response = await axios.post('https://mobiles-survivor-unwrap-bowl.trycloudflare.com/generate_menu_suggestion', {
    ...
    const handleSubmitSuggestion = async () => {
        try {
            ...
            const response = await axios.patch('https://mobiles-survivor-unwrap-bowl.trycloudflare.com/update_menu_suggestion_status', {
